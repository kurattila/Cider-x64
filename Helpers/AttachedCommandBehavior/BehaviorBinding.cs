...
namespace AttachedCommandBehavior
{
    ...
    public class BehaviorBinding : Freezable
    {
        ...
        {
            get { return (IEventFilter)GetValue(EventFilterProperty); }
            set { SetValue(EventFilterProperty, value); }
        }
        ...
        public static readonly DependencyProperty EventFilterProperty =
            DependencyProperty.Register("EventFilter", typeof(IEventFilter), typeof(BehaviorBinding), new UIPropertyMetadata( new PropertyChangedCallback(OnEventFilterChanged)));

        /// <summary>
        /// Handles changes to the EventFilter property.
        /// </summary>
        private static void OnEventFilterChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((BehaviorBinding)d).OnEventFilterChanged(e);
        }

        /// <summary>
        /// EventFilterChanged event handler
        /// </summary>
        /// <param name="e">event args</param>
        protected virtual void OnEventFilterChanged(DependencyPropertyChangedEventArgs e)
        {
            Behavior.EventFilter = EventFilter;
        }
